...
static gboolean dell_get_firmware_version_flag;
...
static GOptionEntry entries[] = {
    ...
    { "dms-dell-get-firmware-revision", 0, 0, G_OPTION_ARG_NONE, &dell_get_firmware_version_flag,
      "Get firmware revision (DELL specific)",
      NULL
    },
...
qmicli_dms_options_enabled (void)
{
    ...
    n_actions = (get_ids_flag +
                 ...
                 dell_get_firmware_version_flag +
                 reset_flag +
                 noop_flag);
                ...
                GCancellable *cancellable)
{
    ...
    if (dell_get_firmware_version_flag) {
        QmiMessageDmsDellGetFirmwareVersionInput *input;

        input = qmi_message_dms_dell_get_firmware_version_input_new ();
        qmi_message_dms_dell_get_firmware_version_input_set_mode (input, 0x01, NULL); /* wtf is this */
